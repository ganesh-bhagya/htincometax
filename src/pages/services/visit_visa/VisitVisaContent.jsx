...
import visitImg from "../../../assets/images/visit-visa.png";
...
export const VisitVisaContent = ({ scrollRef }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A visit visa enables individuals to temporarily travel to a country
          for purposes such as tourism, visiting family or friends, or
          conducting short business activities. Typically issued for a limited
          period, visit visas can be either single-entry or multiple-entry,
          depending on the specific visa regulations of the country and the
          applicant’s travel needs.
        </motion.div>

       
          {visitItems.map((visit, visitIndex) => {
            let turn = visitIndex + 1;
            return (
              <VisitItem
                key={visitIndex}
                open={open}
