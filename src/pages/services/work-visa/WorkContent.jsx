...
import visitImg from "../../../assets/images/work-visa.jpg";
...
export const WorkContent = ({ scrollRef }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A work visa is a type of legal authorization that allows an individual
          to work in A foreign country. It is a document that is issued by the
          government of the country in which the individual wishes to work, and
          it grants them permission to be employed for a specific period of
          time. In order to obtain a work visa, an individual typically needs to
          meet certain criteria, such as having a job offer from a company in
          the foreign country, possessing the necessary qualifications and
          skills required for the job, and passing a background check. The
          process for obtaining a work visa can vary depending on the country,
          and it may involve submitting an application, attending an interview,
          and providing supporting documentation. Once a work visa is granted,
          the individual is legally allowed to work in the foreign country for
          the specified period of time. They are typically required to abide by
          the laws and regulations of the foreign country, and they may need to
          apply for an extension of their visa if they wish to continue working
